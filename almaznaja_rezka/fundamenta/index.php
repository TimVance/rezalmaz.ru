...
$APPLICATION->SetTitle("Алмазная резка фундамента в Москве");
$APPLICATION->SetPageProperty("description", "Компания РезАлмаз предлагает услуги по алмазной резке фундамента. Звоните по телефону +7 (495) 792-93-92.");
?>
<div class="inner_two_column text_style" style="margin-top: -20px;"> 	
  <div class="left_column">   
  <h1>Алмазная резка фундамента</h1>
<p>Алмазная резка фундамента чаще всего требуется в частных жилых домах. Она необходима при перепланировке строения, проведения доступа в подвальное помещение или вырезания проема для окна. Все это можно выполнить с помощью отбойного молотка, но по сравнению с ним <a href="/">алмазная резка</a> обладает рядом преимуществ:</p>
<ul>
 	<li>отсутствие ударных нагрузок;</li>
 	<li>высокая скорость работ;</li>
 	<li>ровная поверхность среза;</li>
 	<li>сравнительно низкий уровень шума;</li>
 	<li>незначительное количество пыли.</li>
</ul>
<h2 class="h2_bg">Особенности алмазной резки фундамента</h2>
<p>Работники компании «РезАлмаз» проводят резку с помощью стенорезных и канатных установок в паре с бурильными устройствами.</p>
<p>Фундамент может быть монолитным либо состоять из блоков ФБС, толщина которых составляет 30, 40, 50 и 60 см. Толщина монолитных фундаментов колеблется от 20 до 60 см.</p>
<p>После демонтажа необходимо провести усиление конструкции с помощью специальных металлоизделий: уголков, швеллеров и так далее.</p>
<h2 class="h2_bg">Стоимость работ</h2>
<p>На итоговую цену влияют:</p>
<ul>
 	<li>длина и глубина реза;</li>
 	<li>степень армированности фундамента;</li>
 	<li>наличие воды и т.д.</li>
</ul>
<p>Компания «РезАлмаз» занимается алмазной резкой более 9 лет. Предоставляем услуги не только в Москве и области, но и в пределах Центрального Федерального округа.</p>
