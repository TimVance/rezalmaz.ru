...
<h1>Услуги в регионах</h1>

<script src="//api-maps.yandex.ru/2.1/?lang=ru_RU" type="text/javascript"></script>

<div id="regions-map">
	<script src="<?=SITE_TEMPLATE_PATH?>/js/yamap-regions.js" type="text/javascript"></script>
</div>

<ul class="regions-list">
<?foreach($arResult["ITEMS"] as $arItem):?>
	<?if (!empty($arItem["DISPLAY_PROPERTIES"]['UF_REGION']['VALUE'])):?>
	<li><a href="<?echo $arItem["DETAIL_PAGE_URL"]?>"><?=$arItem["DISPLAY_PROPERTIES"]['UF_REGION']['VALUE']?></a></li>
	<?endif?>
<?endforeach;?>
</ul>
