...
?><?php $APPLICATION->IncludeComponent(
	...
	public function GetAdminFilterHTML($arProperty, $strHTMLControlName)
	{
		...
		{
			$mxResultValue = self::GetValueForAutoCompleteMulti($arProperty,$_REQUEST[$strHTMLControlName["VALUE"]],$arSymbols['BAN_SYM'],$arSymbols['REP_SYM']);
		...
		{
			$mxResultValue = self::GetValueForAutoCompleteMulti($arProperty,$GLOBALS[$strHTMLControlName["VALUE"]],$arSymbols['BAN_SYM'],$arSymbols['REP_SYM']);
			$strValue = (true == is_array($mxResultValue) ? htmlspecialcharsback(implode("\n",$mxResultValue)) : '');
		}
		ob_start();
		?><?php $control_id = $APPLICATION->IncludeComponent(
