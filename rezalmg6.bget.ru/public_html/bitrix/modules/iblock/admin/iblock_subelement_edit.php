		...
		else
		{
			...
			else
			{
				...
				if (strlen($strWarning) <= 0)
				{
					...
					elseif(isset($_REQUEST["SUB_PREVIEW_PICTURE"]) && is_file($_SERVER["DOCUMENT_ROOT"].$_REQUEST["SUB_PREVIEW_PICTURE"]))
					{
					...
					elseif(isset($_REQUEST["SUB_DETAIL_PICTURE"]) && is_file($_SERVER["DOCUMENT_ROOT"].$_REQUEST["SUB_DETAIL_PICTURE"]))
					{
