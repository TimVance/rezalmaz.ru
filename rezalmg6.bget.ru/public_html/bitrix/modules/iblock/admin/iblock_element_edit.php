...
if ((true == $bOffers) && ((0 == $ID) || $bCopy))
{
	...
	{
		$str_TMP_ID = trim($_REQUEST['TMP_ID']);
...
do{ //one iteration loop
	...
	if ($bOffers) $aTabs[] = array("DIV" => "edit8", "TAB" => GetMessage("IBLOCK_EL_TAB_OFFERS"), "ICON"=>"iblock_element_params", "TITLE"=>GetMessage("IBLOCK_EL_TAB_OFFERS_TITLE"));
...
/*								if (true == $boolFlagClear && true == $boolClearAll)
								{
