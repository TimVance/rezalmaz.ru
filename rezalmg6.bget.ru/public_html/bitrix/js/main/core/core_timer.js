...
{
	BX.CTimer.prototype.formatValue[format_name] = format_handler
}
...
BX.CTimer.prototype.Init = function()
{
	...
	this.formatValue = this.formatValue[this.display] ? this.formatValue[this.display] : this.formatValue.clock;
...
BX.CTimer.prototype.formatValue = {
