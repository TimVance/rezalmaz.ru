				...
				<div class="stage">
					...
					<div class="column">
						...
						<div class="sel_param_row sel_padding">
							...
							<div><input type="text" class="changed_param" id="5376_socket" value="1"></div>
		...
		<div class="stage_4">
			<div class="stage">
				...
				<div class="column_result">
			    	...
			    	<div id="result_callback"><p><a class="callback_link_calc" href="#callback">Оставить заявку</a></p></div>
				...
				switch($('[name="work"]:checked').val()){
					...
					case '5376':
						...
						if(parseInt($('[name="material"]:checked').val()) == 5380){
							...
							res = ((wall * oTypeParam[$('[name="material"]:checked').val()]['1']) + (ceiling * oTypeParam[$('[name="material"]:checked').val()]['2'])) * socket;
						}else{
							res = wall * socket * oTypeParam[$('[name="material"]:checked').val()]['1'];
						}
						res = '<p>Стоимость работы: '+res+' руб.</p>';
					break;
				}
